...
# BASE_DIR = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))) 와 아래줄은 같은 코드
...
SECRET_KEY = 'm&#ozt(_v1mmwk2y*d7vk13^=-fvz$qn*d7j=s_5c294uy05rk'
